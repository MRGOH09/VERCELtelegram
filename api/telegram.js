...
function formatCategoryDetails(categoryBreakdown) {
  ...
  const categoryLabels = {
    ...
    'B': { 'books': '书籍', 'course': '课程', 'training': '培训', 'cert': '认证' },
    'C': { 'stock': '股票', 'fd': '定存', 'insurance': '保险', 'emerg': '紧急基金', 'other': '其他' }
  }
  ...
  const { data: prof } = await supabase
    ...
    if (text.startsWith('/my')) {
      ...
      const msg = formatTemplate(messages.my.summary, {
        ...
        medical: data.snapshotView.medicalMonthly,
        car_insurance: data.snapshotView.carInsuranceMonthly,
