...
function smartCategorize(input, group) {
  const categoryMap = {
    'A': { // 开销
      'food': ['食物', '餐饮', '吃饭', '早餐', '午餐', '晚餐', '零食', '饮料', '咖啡', '茶', '水果', '蔬菜', '肉', '鱼', '米', '面', '油', '盐', '糖', '酱', '醋', '酒', '烟'],
      'shop': ['购物', '买', '采购', '超市', '商场', '商店', '市场', '菜市场', '便利店', '杂货店', '服装店', '鞋店', '包店', '首饰店', '化妆品店', '药店', '文具店', '书店', '玩具店', '礼品店'],
      'transport': ['交通', '公交', '地铁', '打车', '油费', '停车', '车', '汽车', '摩托车', '自行车', '火车', '飞机', '船', '出租车', '网约车', '共享单车', '共享汽车', '过路费', '过桥费', '维修费'],
      'mobile': ['手机', '话费', '流量', '充值', '电话费', '短信费', '上网费', '手机费', '通讯费', '网络费', '宽带费', '网费', '上网', '流量包', '话费包'],
      'household': ['家用', '水电', '煤气', '物业', '维修', '家具', '电器', '装修', '房租', '房贷', '保险', '税', '费', '服务费', '清洁费', '洗衣费', '理发费', '美容费', '健身费', '娱乐费'],
      'other': ['其他', '杂项', '未知', '其他费用', '杂费', '小费', '红包', '礼物', '捐赠', '罚款', '手续费', '服务费', '管理费', '咨询费', '培训费', '考试费', '证书费', '会员费', '订阅费', '年费']
    },
    'B': { // 学习
      'books': ['书籍', '书', '教材', '小说', '杂志', '报纸', '电子书', '课本', '参考书', '工具书', '字典', '词典', '百科全书', '手册', '指南', '教程', '说明书'],
      'course': ['课程', '培训', '学习', '教育', '学校', '大学', '学院', '培训班', '补习班', '兴趣班', '技能班', '职业培训', '在线课程', '网课', '视频课程', '音频课程'],
      'training': ['培训', '技能', '证书', '资格证', '职业资格', '技能证书', '专业培训', '企业培训', '内部培训', '外部培训', '公开课', '讲座', '研讨会', '工作坊', '实训'],
      'cert': ['认证', '考试', '资格证', '证书', '文凭', '学位', '学历', '毕业证', '学位证', '成绩单', '推荐信', '简历', '作品集', '项目经验', '实习证明']
    },
    'C': { // 储蓄
      'stock': ['股票', '投资', '基金', '债券', '期货', '期权', '外汇', '黄金', '白银', '原油', '房地产', '房产', '地产', '土地', '商铺', '写字楼', '住宅', '别墅', '公寓', '平房'],
      'fd': ['定存', '储蓄', '存款', '银行', '利息', '定期', '活期', '零存整取', '整存整取', '存单', '存折', '银行卡', '信用卡', '借记卡', '储蓄卡', '理财', '理财产品', '货币基金', '债券基金', '股票基金'],
      'insurance': ['保险', '保费', '人寿保险', '健康保险', '意外保险', '财产保险', '车险', '医疗险', '重疾险', '养老险', '教育险', '旅游险', '航空险', '货运险', '责任险', '信用险'],
      'emerg': ['紧急', '备用', '应急', '储备', '备用金', '应急金', '风险金', '保障金', '安全金', '保护金', '防护金', '预防金', '准备金', '预备金', '后备金', '后备资金']
    }
  }
