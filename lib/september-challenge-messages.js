...
export const septemberChallengeMessages = {
  // 第一周：正式启动 (1-7天)
  1: '🎉 【正式挑战第1天】31天奇迹之旅，即刻启程！\n\n🌟 欢迎各位伙伴！\n💪 让我们一起践行**巴菲特存钱法**：先储蓄，后消费。\n📱 用 `/record` 记录，为你的财富帝国添砖加瓦。\n🏆 31天后，你将掌握自己的财务未来！\n\n🔥 相信复利，相信坚持的力量！',
  
  2: '🌅 【正式挑战第2天】机会成本，你算了吗？\n\n📝 记账小思考：今天的消费，你放弃了什么？\n💡 **今日提醒**："一杯奶茶等于30粒蛋"。每一笔消费都有它的机会成本。\n🎯 今日任务：记录至少1笔支出，并思考它的"价值"。\n\n💡 看清消费的本质，才能做出更好的选择！',
  
  3: '⭐ 【正式挑战第3天】警惕"快乐消费"！\n\n🏆 恭喜坚持3天！你很棒！\n🛍️ 周末或下班后，我们常为了即时满足而消费。这就是"快乐消费"，它满足的是情绪，而非实际需求。\n📊 查看你的进度：`/my`，看看情绪消费占了多少？\n\n🚀 区分"需要"和"想要"，理财更进一步！',

  4: '💎 【正式挑战第4天】你的消费被操控了吗？\n\n💡 今日思考：你买它，是因为真的需要，还是因为"害怕"？\n🔍 **消费陷阱揭秘**："恐惧消费"利用我们害怕落后、变差的心理，驱动我们消费。\n📈 比如"不xx就晚了"的护肤品，或"不学就被淘汰"的课程。\n⚡ 认清套路，守住钱包！\n\n✨ 你不是因为焦虑而消费，而是为价值付费！',
  
  5: '🎯 【挑战第5天】为"价值"买单！\n\n☕ 上班族的日常消费，如何更有价值？\n💼 **价值消费**的核心是：每笔支出都能带来生活的提升，而非单纯满足一时欲望。\n📱 记录午餐、咖啡时思考：它提升了我的效率还是健康？\n\n👔 让每一分钱都成为提升自己的投资！',
  
  6: '🌈 【挑战第6天】周末，投资"记忆股息"！\n\n🛍️ 周末的消费，除了物质，还能是什么？\n🎬 **尝试新概念**："记忆股息"——创造美好的回忆，它们会在未来持续为你带来精神收益。\n⚖️ 一次家庭出游或与好友的深度交流，远比一件新衣服更"保值"。\n\n🎉 投资难忘的体验，让幸福感持续"派息"！',
...
// 添加挑战消息到晚间提醒
export function addChallengeMessageToEveningReminder(originalMessage, date = new Date()) {
  const challengeMessage = getTodaysChallengeMessage(date)
